...
const PracticeExerciseModal = ({ exercise, isOpen, onClose, onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-[#161b22] border border-gray-700 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-hidden">
        {/* Modal Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div>
            <h2 className="text-xl font-bold text-white">{exercise.title}</h2>
            <p className="text-gray-400 text-sm mt-1">Practice Exercise</p>
          </div>
          <button 
            onClick={onClose}
...
&lt;UserProfile name="John" age={25} email="john@example.com" /&gt;</pre>
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white">
      {/* Header */}
      <div className="bg-green-600 text-white p-6 border-b border-green-700">
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {allExercisesCompleted && (
                    <div className="flex items-center gap-2 text-green-500">
                      <CheckCircle size={20} />
                      <span className="font-semibold">All exercises completed!</span>
                    </div>
                  )}
                </div>
                ...
                <div className="bg-[#1a1f29] rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    {practiceExercises.map((exercise, index) => (
                      <div 
                        key={exercise.id}
                        className="bg-[#0d1117] rounded-lg p-4 border border-gray-700 hover:border-green-500 transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-[#161b22] rounded-lg border border-gray-700 p-6">
              ...
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 ${isCompleted ? 'bg-green-500' : 'bg-gray-600'} rounded-full flex items-center justify-center`}>
                  {isCompleted ? (
            ...
            {/* Exercises Progress */}
            <div className="bg-[#161b22] rounded-lg border border-gray-700 p-6">
              <h3 className="font-semibold text-white mb-4">Exercises Progress</h3>
              <div className="space-y-2">
            ...
            {/* Navigation Card */}
            <div className="bg-[#161b22] rounded-lg border border-gray-700 p-6">
              <h3 className="font-semibold text-white mb-4">Course Navigation</h3>
